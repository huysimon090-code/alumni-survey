# 🎓 alumni-survey - Easy Feedback Collection for Alumni

## ⭐ Key Features
- Simple interface for sending professional emails.
- Gather valuable feedback from alumni.
- Improve your services with actionable insights.
...
5. Extract the contents of the zip file. You can do this by right-clicking on the file and selecting "Extract All."
6. Open the extracted folder. You will find the executable file to run the application.
7. Double-click the executable file to launch the application.

## 🎉 Using the Application
Once the application is running, follow these steps to send out your survey request email to alumni:

1. **Setup Your Email Account**: You’ll need to connect your email account within the application. This will allow the software to send emails on your behalf.
2. **Create Your Survey Email**: Use the built-in email template to customize your survey request. Fill in details such as the subject, body text, and any other information you want to include.
3. **Select Recipients**: You can import a list of alumni email addresses or add them manually within the application.
4. **Send the Email**: After reviewing your email, click the "Send" button. The application will take care of the rest.

## 📋 System Requirements
To run the alumni-survey application, ensure your system meets these requirements:
...
## 🛠️ Troubleshooting
If you encounter any issues while using the alumni-survey application, please check the following common problems:
